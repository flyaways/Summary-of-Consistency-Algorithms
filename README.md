...
| 算法        | 类型|算法说明   |  作者  |发布日期  |应用|备注|
| --------   | :-----:|:-----  | :----:  |:----:  |:----:|
| Paxos      | 非拜占庭将军容错|基于消息传递的一致性算法，Paxos 中包含 Basic Paxos、Multi-Paxos、Cheap Paxos   |   Leslie Lamport     |  1990   |||
| Raft       | 非拜占庭将军容错|管理复制日志的一致性算法   |  Diego Ongaro   | 2014|etcd||
| POW       | 拜占庭将军容错|工作量证明（POW）  |  Cynthia Dwork,Moni Naor   | 1993|Bitcoin||
| POS       | 拜占庭将军容错|权益证明（POS）   |  Diego Ongaro   | 天|Ethereum||
| DPOS       | 拜占庭将军容错|委托权益证明（DPOS）   |  Diego Ongaro   | |||
